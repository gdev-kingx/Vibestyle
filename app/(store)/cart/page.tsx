...
function CartPage() {
    ...
    if (groupedItems.length === 0) {
        return (
            <div className="container mx-auto p-4 flex flex-col items-center jusitfy-center min-h-[50vh]">
    ...
    return (
        <div className="container mx-auto p-4 max-w-6xl">
            <h1 className="text-2xl font-bold mb-4 text-gray-800">My Cart</h1>
                ...
                <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
                    ...
                    {isSignedIn ? (
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full mt-4 bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 disabled:bg-gray-400"
                        >
